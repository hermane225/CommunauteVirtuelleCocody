      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          ...
          <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Pour contacter la Communauté Virtuelle de Cocody (CVC), vous pouvez utiliser les
        ...
        <div class="mt-10">
          <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            ...
            <div class="flex">
              ...
              <div class="ml-4">
                <dt class="text-lg leading-6 font-medium text-gray-900">Télphone</dt>
                <dd class="mt-2 text-base text-gray-500">0768660047</dd>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div class="ml-4">
                ...
                <dd class="mt-2 text-base text-gray-500">gboho.noufe@uvci.edu.ci</dd>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div class="ml-4">
                <dt class="text-lg leading-6 font-medium text-gray-900">
                  Jours & heure de recontre
                </dt>
                <dd class="mt-2 text-base text-gray-500">Chaque Samedi à partir de 8 h<br /></dd>
              </div>
            </div>
          </dl>
        </div>
